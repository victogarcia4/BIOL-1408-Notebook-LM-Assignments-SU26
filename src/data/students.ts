...
export const BUILT_NOTEBOOKS: NotebookLM[] = [
  {
    objective: "Describe nucleic acid structure and define the two types of nucleic acids.",
    url: "https://notebooklm.google.com/notebook/3421f8d7-a882-4b28-8d59-b08e94c735e5",
    unit: 1,
    authors: ["Sharissa Richard"]
  },
  {
    objective: "Describe the four major types of lipids.",
    url: "https://notebooklm.google.com/notebook/6c553ffa-6ee7-4960-8f1d-37d143ee0d53?authuser=1",
    unit: 1,
    authors: ["Mary Jane Kononen"]
  },
  {
    objective: "Identify the shared characteristics of the natural sciences.",
    url: "https://notebooklm.google.com/notebook/ea1f8d98-6dfe-400a-a19b-7c94c8e49a32?authuser=1",
    unit: 1,
    authors: ["Alejandra Crispin"]
  },
  {
    objective: "Discuss the role of carbohydrates in cells and extracellular materials.",
    url: "https://notebooklm.google.com/notebook/e75afffc-5623-48fd-86be-ac415c75a95e",
    unit: 1,
    authors: ["Mikayla Vance"]
  },
  {
    objective: "Explain DNA structure and role.",
    url: "https://notebooklm.google.com/notebook/ca8141a1-3104-4b51-970e-e16a02dbce4e?pli=1",
    unit: 1,
    authors: ["Mason Stallons"]
  },
  {
    objective: "Define the quiescent G0 phase.",
    url: "https://notebooklm.google.com/notebook/8aef0eee-97fe-45b3-98bc-29aa56255933?authuser=1",
    unit: 2,
    authors: ["Mary Jane Kononen"]
  },
  {
    objective: "Identify non-Mendelian inheritance patterns.",
    url: "https://notebooklm.google.com/notebook/c16a05d0-e83d-4cc5-9692-2d795a4c2f45?authuser=1",
    unit: 3,
    authors: ["Mary Jane Kononen"]
  },
  {
    ...
    url: "https://notebooklm.google.com/notebook/50be1ede-429a-40e6-af13-9be8f87eeac2?authuser=1",
    unit: 4,
    authors: ["Mary Jane Kononen", "Karen Arreguin"]
  }
];
